        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="cart__discount">
                    <h6>Returns are only accepted if the courier is still at your door. If you’re not satisfied with the order, you’ll be responsible for the shipping costs.</h6>
                </div>
