        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="testimonial__text">
                    ...
                    <p>
                        At j’s, we create an experience. Our collection is designed with the modern woman in mind, blending timeless elegance with exceptional quality. Each piece is carefully crafted from the finest fabrics, ensuring comfort, durability, and an unparalleled luxurious feel.

                        We don't just sell abayas; we are a family dedicated to making you feel confident, elegant, and truly special every time you wear our creations. Our attention to detail, from the stitching to the finishing touches, reflects our passion for craftsmanship and quality.
                        Experience the essence of luxury with every piece we offer.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 p-0">
                <div class="testimonial__pic set-bg" data-setbg="assets/img/IMG_4058.JPG"></div>
            </div>
        </div>
    </div>
</section>
